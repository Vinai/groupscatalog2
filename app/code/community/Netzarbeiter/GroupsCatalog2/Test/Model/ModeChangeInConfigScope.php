...
/**
 * This test refers to issue https://github.com/Vinai/groupscatalog2/issues/33
 *
 * @doNotIndexAll
 * @loadSharedFixture hiddenByDefault.yaml
 */
class Netzarbeiter_GroupsCatalog2_Test_Model_ModeChangeInConfigScope extends EcomDev_PHPUnit_Test_Case
{
    /**
     ...
     */
    public function loadEavProductCollectionWithModeChangeInConfigDefaultSettingScope($storeCode, $customerGroupId)
    {
